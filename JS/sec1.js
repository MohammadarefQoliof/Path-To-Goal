...
let prices = []
let times = []
if (!localStorage.getItem("sec1 checked")) {
    let checkedBoxes = [];
...
if(localStorage.getItem("sec1 saved") == "false"){
    ...
    for(let i = 0; i<nameoftasks.length; i++){
        ...
        if(price == "false"){
            ...
            let checkedArr = JSON.parse(localStorage.getItem("sec1 checked")) || [];
            let checkedNum = Number(localStorage.getItem("sec1 checked num"))
            ...
            checkboxInput.addEventListener("change", () => {
                if (checkboxInput.checked){
                    checkedNum+=1
                    localStorage.setItem("sec1 checked num", checkedNum)
                }
                else{
                    checkedNum-=1
                    localStorage.setItem("sec1 checked num", checkedNum)
                ...
                localStorage.setItem("sec1 checked", JSON.stringify(checkedArr));
